...
export function YoutubeIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      {/* Background rounded rect — fills with currentColor (white in dark footer) */}
      <path
        fill="currentColor"
      ...
      />
      {/* Play triangle — transparent so the container bg shows through as dark cutout */}
      <path
        d="M9.75 15.02 15.5 12 9.75 8.98z"
        fill="#111111"
      />
    </svg>
  );
